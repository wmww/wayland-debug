...
class Plugin:
    ...
    def __init__(self, out, connection_id_sink, command_sink, ui_state):
        ...
        WlClosureCallBreakpoint(self, 'wl_closure_invoke', extract.wl_closure_invoke)
        WlClosureCallBreakpoint(self, 'wl_closure_dispatch', extract.wl_closure_dispatch)
        WlClosureCallBreakpoint(self, 'wl_closure_send', extract.wl_closure_send)
        WlClosureCallBreakpoint(self, 'wl_closure_queue', extract.wl_closure_queue)
        WlCommand(self, 'w')
        WlCommand(self, 'wl')
